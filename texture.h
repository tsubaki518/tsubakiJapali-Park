...
enum TextureIndex
{
	...
	TEXTURE_INDEX_SCOR_MESSAGE,	// スコアメッセージ
	...
	TEXTURE_INDEX_RANKING_WAKU,
	TEXTURE_INDEX_RANKING_GOLD,
	TEXTURE_INDEX_RANKING_SILVER,
	TEXTURE_INDEX_RANKING_COPPER,
	TEXTURE_INDEX_RANKING_ANIME,
