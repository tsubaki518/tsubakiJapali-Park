...
{ "asset/texture/ボードの上に乗り.png",353,108 },
{ "asset/texture/どちらかがジャンプすると～.png",594,107 },
{ "asset/texture/まもなくレース.png",353,65 },
...
{ "asset/texture/雪パーティクル用.png",SCREEN_WIDTH,SCREEN_HEIGHT },

{ "asset/texture/ありがと.png",SCREEN_WIDTH,SCREEN_HEIGHT },
};
// 読み込みテクスチャ数
